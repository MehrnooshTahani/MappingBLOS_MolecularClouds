...
try:
    ...
    print("----------------------------------------------------------------")
    print("Error: One of the following data files could not be read!")
    print(BData_Density50IncreasePath)
    print(BData_Density50DecreasePath)
    print("This script will fail, and the uncertainties cannot be calculated.")
    print("----------------------------------------------------------------")
...
try:
    ...
    print("----------------------------------------------------------------")
    print("Error: One of the following data files could not be read!")
    print(BData_Temp20IncreasePath)
    print(BData_Temp20DecreasePath)
    print("This script will fail, and the uncertainties cannot be calculated.")
    print("----------------------------------------------------------------")
